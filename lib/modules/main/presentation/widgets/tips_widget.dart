...
final tipsTimerProvider = Provider<Timer?>((ref) {
  ...
  final tips = <Map<String, String?>>[
    <String, String?>{
      'title': 'Hello 👋',
      'message':
          'MetaCore can provide you with a safer and more private browsing experience.',
    },
    <String, String?>{
      'title': null,
      'message':
...
// Tips data provider with branding awareness
final tipsDataProvider = Provider<List<Map<String, String?>>>((ref) {
  ...
  return [
    {
      'title': 'Hello 👋',
      'message':
          '$appName can provide you with a safer and more private browsing experience.',
    },
    {
      'title': null,
      'message':
